...
char EID1[] = "20203494"; //  ;replace abc123 with your EID
char EID2[] = "20203494"; //  ;replace abc123 with your EID
...
//    NONE
  ...
  //EnableInterrupts();
  while(1){         
		switch (Key_In()){																// Read inputs from Port E --> period (index of Notes array) for each key
			case 0x04:				
				Sound_Start(C7); //Key0=261.6Hz
				break;
			case 0x08:
				Sound_Start(E0); //Key1=329.6Hz
				break;
			case 0x10:
				Sound_Start(G0); //Key2=392.0Hz
				break;
			case 0x20:
				Sound_Start(A0); //Key3=440.0 Hz
				break;
			default:
				Sound_Start(0);
				break;
